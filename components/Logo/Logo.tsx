 ...
 *
 * Renders a clickable logo that links to the homepage, styled using a combination of Tailwind utility classes and a custom glitch effect from `Logo.module.css`.
 *
